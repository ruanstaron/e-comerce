...
function bavotasan_default_theme_options() {
	//delete_option( 'theme_mods_tienda' );
	return array(
		'width' => '1170',
		'layout' => 'right',
		'primary' => 'col-md-9',
...
class Bavotasan_Customizer {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'width', array(
			'label' => __( 'Site Width', 'tienda' ),
			'section' => 'bavotasan_layout',
			'priority' => 10,
			'type' => 'select',
			'choices' => array(
				'1170' => __( '1200px', 'tienda' ),
				'992' => __( '992px', 'tienda' ),
			),
		) );
		...
		$wp_customize->add_control( 'primary', array(
			'label' => __( 'Main Content Width', 'tienda' ),
			'section' => 'bavotasan_layout',
			'priority' => 15,
			'type' => 'select',
			'choices' => $choices,
