		...
		<div id="primary" <?php bavotasan_primary_attr(); ?>>
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div id="posts-pagination" class="clearfix">
					<h3 class="sr-only"><?php _e( 'Post navigation', 'tienda' ); ?></h3>
					<div class="previous pull-left"><?php previous_image_link( false, __( '<span class="meta-nav">&larr;</span> Previous Image', 'tienda' ) ); ?></div>
					<div class="next pull-right"><?php next_image_link( false, __( 'Next Image <span class="meta-nav">&rarr;</span>', 'tienda' ) ); ?></div>
